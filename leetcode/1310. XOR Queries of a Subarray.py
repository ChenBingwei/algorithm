# Given the array arr of positive integers and
# the array queries where queries[i] = [Li,  Ri],
# for each query i compute the XOR of elements
...
class Solution:
    ...
    def xorQueries2(self, arr, queries):
        xors = [0]
        for num in arr:
